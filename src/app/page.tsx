    ...
    return (
      <div className="mx-auto max-w-2xl flex-1 px-4 py-20 sm:px-6">
        <EmptyState
          ...
          description={`Check .env.local and Aiven connectivity. ${agg.error}`}
        />
      </div>
    );
  }
  if (!featured.ok) {
    return (
      <div className="mx-auto max-w-2xl flex-1 px-4 py-20 sm:px-6">
        <EmptyState
          title="Database unavailable"
          description={`Check .env.local and Aiven connectivity. ${featured.error}`}
        />
      </div>
    );
  }
  if (!months.ok) {
    return (
      <div className="mx-auto max-w-2xl flex-1 px-4 py-20 sm:px-6">
        <EmptyState
          title="Database unavailable"
          description={`Check .env.local and Aiven connectivity. ${months.error}`}
        />
      </div>
    );
  }
